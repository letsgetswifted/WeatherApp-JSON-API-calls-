...
//  WeatherApp
//
//  Created by Rajinikumar Rai on 13/01/2019.
...
class WeatherViewController: UIViewController, CLLocationManagerDelegate, ChangeCityDelegate {
    ...
    let APP_ID = "e59d6656c7d0bd75e1ca3fea6e1a4a8e"
    ...
    func updateWeatherData(json: JSON) {
        ...
        updateUIWithWeatherData()
            ...
            print("Error retreiving weather data")
            cityLabel.text = "unable to gather weather data"
        }
